...
public class AppConstants {
  ...
  public static final String RELEASE_CHANNEL = "sancte-rosarium";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@veritas/rosarium", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40veritas%2Frosarium%2F1.0.1%2F88ff782769a27b6d802fb93d2743d9a3-35.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
